...
/**
 * Tests the BooleanEqConstraint
 * 
 * @author Chris Johnson
 */
public class EqTwoVarConstraintTest extends TestCase {
	private BooleanVariable aVar;
    private BooleanVariable bVar;
	private CspSolver solver;
	private CspConstraint constraint;
	
    public EqTwoVarConstraintTest(java.lang.String testName) {
        super(testName);
    }
    ...
    public void testSetAFalse() {
        try {
            constraint = new BooleanEqTwoVarConstraint(aVar, bVar);
