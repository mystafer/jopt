...
public class ChoicePointWithConstraintsTest extends TestCase {
    ...
    public void setUp () {
        ...
        xjikexpr = (GenericIntExpr)varFactory.genericInt("xjik", new GenericIndex[]{idxJ, idxI, idxK}, new CspIntVariable[]{x111,x121,x131,x211,x221,x231,x311,x321,x331,
    ...
    public void testSummationEQVarWithReset() {
        try {
            ...
            //make sure the constraint is still present and active
            x1.setMin(10);
    ...
    public void testSummationLTVarWithPop() {
        try {
            ...
            // the costraint should still be present and active
            x1.setMin(10);
            ...
            // now, if we pop, it should reset the vars/exprs and discard the constraint
            choicestack.pop();
    ...
    public void testSummationGTVarWithPopAndPush() {
        try {
            ...
            // push the constraint back onto the cps
            choicestack.pushDelta(data);
