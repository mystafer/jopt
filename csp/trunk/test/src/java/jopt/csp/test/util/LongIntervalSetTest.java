 ...
 */
public class LongIntervalSetTest extends TestCase {
    
    LongIntervalSet set;
    TestListener listener;
    
	public LongIntervalSetTest(String testName) {
        super(testName);
    }
    
    public void setUp() {
        set = new LongIntervalSet();
    ...
    public void testRetainAllWithOverlap() {
        ...
        LongIntervalSet retain = new LongIntervalSet();
        retain.add(5, 7);
    ...
    public void testClone() {
        ...
        LongIntervalSet clone = (LongIntervalSet) set.clone();
        clone.remove(3, 7);
    ...
    public class TestListener implements LongIntervalSetListener {
        ArrayIntList rmCallbacks;
        ArrayLongList rmStarts;
        ArrayLongList rmEnds;
        ArrayIntList addCallbacks;
        ArrayLongList addStarts;
        ArrayLongList addEnds;
        
        public TestListener() {
            addCallbacks = new ArrayIntList();
            addStarts = new ArrayLongList();
            addEnds = new ArrayLongList();
            rmCallbacks = new ArrayIntList();
            rmStarts = new ArrayLongList();
            rmEnds = new ArrayLongList();
        }
