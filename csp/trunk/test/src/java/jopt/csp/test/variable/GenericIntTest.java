 ...
 */
public class GenericIntTest extends TestCase {
     ...
     */
    public GenericIntTest(String name) {
        super(name);
    }
    ...
    public void testZiEqXiAddYi() {
        try {
            ...
            for (int i=0; i<idxI.size(); i++) {
                ...
                assertEquals("z" + idxI.currentVal() + " min", 100, z.getMin());
                assertEquals("z" + idxI.currentVal() + " max", 100, z.getMax());
            }
        }
