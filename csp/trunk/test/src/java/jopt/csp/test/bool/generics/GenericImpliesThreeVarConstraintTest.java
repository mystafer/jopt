 ...
 */
public class GenericImpliesThreeVarConstraintTest extends TestCase {
    ...
    public GenericImpliesThreeVarConstraintTest(java.lang.String testName) {
        super(testName);
    }
    ...
    public void testSettingX1FalseGenericVarConstTrue() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, y, false, true);
            ...
            assertFalse("y isTrue should be false", y.isTrue());
            assertFalse("y isFalse should be false", y.isFalse());
            //The remaining Xi's are undetermined
            assertFalse("x2 isTrue should be false", x2.isTrue());
            assertFalse("x2 isFalse should be false", x2.isFalse());
            assertFalse("x3 isTrue should be false", x3.isTrue());
            assertFalse("x3 isFalse should be false", x3.isFalse());
    ...
    public void testSettingX1FalseGenericVarConstFalse() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, y, false, false);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
    ...
    public void testSettingX1FalseConstGenericVarConstFalse() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yiconst, ziexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            ...
            assertFalse("x3 isTrue should be false", x3.isTrue());
            assertFalse("x3 isFalse should be false", x3.isFalse());
            //z3 should already be determined to be true.
            assertFalse("z1 isTrue should be flase", z1.isTrue());
            assertFalse("z1 isFalse should be false", z1.isFalse());
            assertFalse("z2 isTrue should be false", z2.isTrue());
            assertFalse("z2 isFalse should be false", z2.isFalse());
            ...
            x2.setFalse();
            store.propagate();
            //Now everything should be determined besides x3, but x3 will be true
            //no matter what it is, so the constraint should be true
            //The constraint is false
            ...
            assertFalse("z2 isFalse should be false", z2.isFalse());
            //x1 should be true
            assertTrue("x1 isTrue should be false", x1.isTrue());
            assertFalse("x1 isFalse should be false", x1.isFalse());
    ...
    public void testSettingX1TrueGenericVarConstTrue() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, y, false, true);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
    ...
    public void testSettingX1FalseGenericVarVar() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, y, false, z);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
    ...
    public void testSettingZFalseGenericVarVar() {
        try {
            ...
            assertFalse("y isTrue should be false", y.isTrue());
            assertTrue("y isFalse should be true", y.isFalse());
            //The Xi's should now be true
            assertTrue("x1 isTrue should be true", x1.isTrue());
            assertFalse("x1 isFalse should be false", x1.isFalse());
            assertTrue("x2 isTrue should be true", x2.isTrue());
            assertFalse("x2 isFalse should be false", x2.isFalse());
            assertTrue("x3 isTrue should be true", x3.isTrue());
    ...
    public void testSettingZFalseX1FalseGenericVarVar() {
        try {
            ...
            //The constraint remains undetermined until propagation
            assertFalse("the constraint is not true", constraint.isTrue());
            assertTrue("the constraint is not trues", constraint.isFalse());
            //The other variables should still be undetermined
            assertFalse("x2 isTrue should be false", x2.isTrue());
            assertFalse("x2 isFalse should be false", x2.isFalse());
            assertFalse("x3 isTrue should be false", x3.isTrue());
    ...
    public void testSettingYFalseX1TrueGenericVarVar() {
        try {
            ...
            assertTrue("the constraint is true", constraint.isTrue());
            assertFalse("the constraint is not false", constraint.isFalse());
            //The remaining Xi's should be determined
            assertTrue("x2 isTrue should be true", x2.isTrue());
            assertFalse("x2 isFalse should be false", x2.isFalse());
            assertTrue("x3 isTrue should be true", x3.isTrue());
            assertFalse("x3 isFalse should be false", x3.isFalse());
    ...
    public void testSettingXFalseVarGenericVar() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(x, yiexpr, false, z);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
    ...
    public void testSettingXFalseVarVarGeneric() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(x, y, false, ziexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
    ...
    public void testSettingX1FalseGenericGenericVarSameIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yiexpr, false, z);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
    ...
    public void testSettingX1FalseGenericGenericVarDiffIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yjexpr, false, z);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
    ...
    public void testSettingX1TrueY2FalseZTrueGenericGenericVarDiffIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yjexpr, false, z);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
    ...
    public void testSettingX1FalseGenericVarGenericDiffIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, y, false, ziexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
            ...
            assertFalse("y isTrue should be false", y.isTrue());
            assertFalse("y isFalse should be false", y.isFalse());
            //Z1 should now be true, the rest should be undetermined
            assertTrue("z1 isTrue should be true", z1.isTrue());
            assertFalse("z1 isFalse should be false", z1.isFalse());
            assertFalse("z2 isTrue should be false", z2.isTrue());
            assertFalse("z2 isFalse should be false", z2.isFalse());
    ...
    public void testSettingX11FalseGenericGenericVarComboIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xijexpr, yiexpr, false, z);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
    ...
    public void testSettingX11FalseGenericVarGenericComboIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xijexpr, y, false, ziexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
    ...
    public void testSettingX1FalseGenericGenericGenericSameIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yiexpr, false, ziexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
            ...
            assertFalse("all Z's are false", ziexpr.isAllFalse());
            assertFalse("no Z is false", ziexpr.isAnyFalse());
            assertFalse("not all Z's are true", ziexpr.isAllTrue());
            assertTrue("at least one Z is true", ziexpr.isAnyTrue());
        }
        catch (PropagationFailureException pfe) {
        	fail();
		}
    ...
    public void testSettingX1FalseGenericGenericGenericSimilarIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yiexpr, false, zjexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
    ...
    public void testSettingX1FalseGenericGenericGenericDiffIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xiexpr, yjexpr, false, zkexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
    ...
    public void testSettingX11FalseGenericGenericGenericComboIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xijexpr, yiexpr, false, ziexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
            ...
            assertFalse("y3 isTrue should be false", y3.isTrue());
            assertFalse("y3 isFalse should be false", y3.isFalse());
            //Z1 should now be true, the remaining Zk's should be undetermined
            assertTrue("z1 isTrue should be true", z1.isTrue());
            assertFalse("z1 isFalse should be false", z1.isFalse());
            assertFalse("z2 isTrue should be false", z2.isTrue());
            assertFalse("z2 isFalse should be false", z2.isFalse());
    ...
    public void testSettingX11TrueZ1TrueGenericGenericGenericComboDiffIndex() {
        try {
            BooleanImpliesThreeVarConstraint constraint = new BooleanImpliesThreeVarConstraint(xijexpr, yiexpr, false, zkexpr);
        	store.addConstraint(constraint);
        	assertFalse("the unbound constraint is not true", constraint.isTrue());
            assertFalse("the unbound constraint is not false", constraint.isFalse());
            //Now we determine one of the variables
