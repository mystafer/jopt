...
import jopt.csp.util.FloatIntervalSetListener;
 ...
 */
public class FloatIntervalSetTest extends TestCase {
    
    FloatIntervalSet set;
    TestListener listener;
    
	public FloatIntervalSetTest(String testName) {
        super(testName);
    }
    
    public void setUp() {
        set = new FloatIntervalSet();
    ...
    public void testIntervalAdditionDoubleAdjacent() {
        ...
        set.add(0, FloatUtil.previous(25));
    ...
    public void testIntervalAdditionTripleAdjacentBoth() {
        ...
        set.add(FloatUtil.next(25), FloatUtil.previous(75));
    ...
    public void testIntervalAdditionTripleAdjacentOneOverlapOther() {
        ...
        set.add(22, FloatUtil.previous(75));
        ...
        while (index != -1) {
            switch (count) {
                case 0:
                    ...
                    assertEquals("0..24", FloatUtil.previous(25), set.getMax(index), 0);
                    break;
                case 1:
                    assertEquals("76..100", FloatUtil.next(75), set.getMin(index), 0);
    ...
    public void testIntervalRemovalEnd() {
        ...
        assertEquals("min is 0", 0, set.getMin(), 0);
        assertEquals("max is 74", FloatUtil.previous(75), set.getMax(), 0);
    ...
    public void testIntervalRemovalStart() {
        ...
        assertEquals("min is 26", FloatUtil.next(25), set.getMin(), 0);
        assertEquals("max is 100", 100, set.getMax(), 0);
        ...
        while (index != -1) {
            switch (count) {
                ...
                case 1:
                    ...
                    assertEquals("0..19", FloatUtil.previous(20), set.getMax(index), 0);
                    break;
            }
            index = set.getPreviousIntervalIndex(index);
            count++;
    ...
    public void testIntervalRemovalDoublePartialStart() {
        ...
        while (index != -1) {
            switch (count) {
                case 0:
                    assertEquals("81..100", FloatUtil.next(80), set.getMin(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                ...
                case 1:
                    ...
                    assertEquals("50..69", FloatUtil.previous(70), set.getMax(index), 0);
                    break;
                case 2:
                    assertEquals("80..100", 80, set.getMin(index), 0);
                    assertEquals("80..100", 100, set.getMax(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                case 0:
                    ...
                    assertEquals("80..94", FloatUtil.previous(95), set.getMax(index), 0);
                    break;
                case 1:
                    assertEquals("50..75", 50, set.getMin(index), 0);
                    assertEquals("50..75", 75, set.getMax(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                case 0:
                    ...
                    break;
                case 1:
                    assertEquals("56..75", FloatUtil.next(55), set.getMin(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    assertEquals("86..100", FloatUtil.next(85), set.getMin(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    assertEquals("116..130", FloatUtil.next(115), set.getMin(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                ...
                case 2:
                    ...
                    assertEquals("80..84", FloatUtil.previous(85), set.getMax(index), 0);
                    break;
                case 3:
                    assertEquals("96..100", FloatUtil.next(95), set.getMin(index), 0);
    ...
    public void testMultipleIntervalAdditionAndRemoval() {
        ...
        while (index != -1) {
            switch (count) {
                ...
                case 1:
                    ...
                    assertEquals("60..70", FloatUtil.previous(70), set.getMax(index), 0);
                    break;
                case 2:
                    assertEquals("90..100", FloatUtil.next(90), set.getMin(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                case 0:
                    ...
                    break;
                case 1:
                    assertEquals("80..85", FloatUtil.next(80), set.getMin(index), 0);
        ...
        while (index != -1) {
            switch (count) {
                case 0:
                    assertEquals("0..25", 0, set.getMin(index), 0);
                    assertEquals("0..25", FloatUtil.previous(25), set.getMax(index), 0);
                    break;
                case 1:
                    assertEquals("75..100", FloatUtil.next(75), set.getMin(index), 0);
                    assertEquals("75..100", 100, set.getMax(index), 0);
                    break;
            }
            index = set.getNextIntervalIndex(index);
    ...
    public void testRetainAllWithOverlap() {
        ...
        FloatIntervalSet retain = new FloatIntervalSet();
        retain.add(5, 7);
    ...
    public void testClone() {
        ...
        FloatIntervalSet clone = (FloatIntervalSet) set.clone();
        clone.remove(3, 7);
    ...
    public class TestListener implements FloatIntervalSetListener {
        ArrayIntList rmCallbacks;
        ArrayFloatList rmStarts;
        ArrayFloatList rmEnds;
        ArrayIntList addCallbacks;
        ArrayFloatList addStarts;
        ArrayFloatList addEnds;
        
        public TestListener() {
            addCallbacks = new ArrayIntList();
            addStarts = new ArrayFloatList();
            addEnds = new ArrayFloatList();
            rmCallbacks = new ArrayIntList();
            rmStarts = new ArrayFloatList();
            rmEnds = new ArrayFloatList();
        }
