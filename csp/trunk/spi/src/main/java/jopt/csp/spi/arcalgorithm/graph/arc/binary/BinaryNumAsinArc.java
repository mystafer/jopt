 ...
 */
public class BinaryNumAsinArc extends BinaryNumArc {
     ...
     */
    public BinaryNumAsinArc(NumNode x, NumNode z, int nodeType, int arcType) {
        super(x, null, null, null, z, nodeType, arcType, NumOperation.ASIN);
    }
    ...
    protected void propagateBounds() throws PropagationFailureException {
        ...
        TrigMath.asinMinMax(z, x, z.getPrecision(), min, max);
