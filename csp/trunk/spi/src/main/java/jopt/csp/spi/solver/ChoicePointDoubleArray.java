...
/**
 * A double array that stores data for an object that needs to record changes in a
 ...
 */
public class ChoicePointDoubleArray implements ChoicePointNumArraySet.StackList {
	private ArrayIntList basePointerStack;
    private ArrayIntList sizeStack;
    private double dataStack[];
