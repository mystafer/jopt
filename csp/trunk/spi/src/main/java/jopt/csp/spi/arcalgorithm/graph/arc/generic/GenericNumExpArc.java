 ...
 */
public class GenericNumExpArc extends GenericNumTrigArc {
     ...
     */
    public GenericNumExpArc(Node x, Node z, int nodeType, int arcType) {
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        TrigMath.expMinMax(currentNz, currentNx, precision, min, max);
