 ...
 */
public class GenericNumAsinArc extends GenericNumTrigArc {
     ...
     */
    public GenericNumAsinArc(Node x, Node z, int nodeType, int arcType) {
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumAsinArc(Number x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumAsinArc(GenericNumConstant x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        if (currentXConst != null)
            TrigMath.asinMinMax(currentNz, currentXConst.doubleValue(), precision, min, max);
        else
            TrigMath.asinMinMax(currentNz, currentNx, precision, min, max);
