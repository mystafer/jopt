 ...
 */
public class BinaryNumAcosArc extends BinaryNumArc {
     ...
     */
    public BinaryNumAcosArc(NumNode x, NumNode z, int nodeType, int arcType) {
        super(x, null, null, null, z, nodeType, arcType, NumOperation.ACOS);
    }
    ...
    protected void propagateBounds() throws PropagationFailureException {
        ...
        TrigMath.acosMinMax(z, x, z.getPrecision(), min, max);
