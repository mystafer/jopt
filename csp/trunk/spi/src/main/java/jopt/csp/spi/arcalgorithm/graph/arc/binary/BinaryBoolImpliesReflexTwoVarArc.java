 ...
 */
public class BinaryBoolImpliesReflexTwoVarArc extends BinaryBoolArc {
    /**
     * Constraint
     * 
     ...
     */
    public BinaryBoolImpliesReflexTwoVarArc(BooleanNode a, boolean notA, BooleanNode z, boolean notZ) {
        super(a, notA, z, notZ);
    }
