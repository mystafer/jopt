 ...
 */
public class FloatNode extends AbstractNode implements NumNode {
    protected FloatDomain domain;
     ...
     * Constructor
     */
    public FloatNode(String name, FloatDomain domain) {
        super(name);
        this.domain = domain;
     ...
     */
    public FloatNode() {
        this(NameUtil.nextName(), new FloatIntervalDomain(Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY));
    }
    ...
    public Number getMax() {
        max.setFloatValue(domain.getMax());
        return max;
    }
    ...
    public Number getMin() {
        min.setFloatValue(domain.getMin());
        return min;
    }
    ...
    public boolean isInDomain(Number val) {
        return domain.isInDomain(val.floatValue());
    }
    ...
    public Number getNextHigher(Number n) {
        nextHigher.setFloatValue(domain.getNextHigher(n.floatValue()));
        return nextHigher;
    }
    ...
    public Number getNextLower(Number n) {
        nextLower.setFloatValue(domain.getNextLower(n.floatValue()));
        return nextLower;
    }
    ...
    public void removeValue(Number n) throws PropagationFailureException {
        domain.removeValue(n.floatValue());
    }
    ...
    public void removeRange(Number start, Number end) throws PropagationFailureException {
        domain.removeRange(start.floatValue(), end.floatValue());
    }
    ...
    public void setRange(Number start, Number end) throws PropagationFailureException {
        domain.setRange(start.floatValue(), end.floatValue());
    }
