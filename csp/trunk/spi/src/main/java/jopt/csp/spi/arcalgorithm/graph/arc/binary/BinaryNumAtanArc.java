 ...
 */
public class BinaryNumAtanArc extends BinaryNumArc {
     ...
     */
    public BinaryNumAtanArc(NumNode x, NumNode z, int nodeType, int arcType) {
        super(x, null, null, null, z, nodeType, arcType, NumOperation.ATAN);
    }
    ...
    protected void propagateBounds() throws PropagationFailureException {
        ...
        TrigMath.atanMinMax(z, x, z.getPrecision(), min, max);
