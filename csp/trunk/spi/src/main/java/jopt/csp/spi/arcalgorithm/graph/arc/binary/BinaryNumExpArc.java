 ...
 */
public class BinaryNumExpArc extends BinaryNumArc {
     ...
     */
    public BinaryNumExpArc(NumNode x, NumNode z, int nodeType, int arcType) {
        super(x, null, null, null, z, nodeType, arcType, NumOperation.EXP);
    }
    
    protected void propagateBounds() throws PropagationFailureException {
        // Calculate min and max values
        TrigMath.expMinMax(z, x, z.getPrecision(), min, max);
