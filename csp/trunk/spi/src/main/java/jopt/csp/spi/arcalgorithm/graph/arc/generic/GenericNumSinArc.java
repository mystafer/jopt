 ...
 */
public class GenericNumSinArc extends GenericNumTrigArc {
     ...
     */
    public GenericNumSinArc(Node x, Node z, int nodeType, int arcType) {
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumSinArc(Number x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumSinArc(GenericNumConstant x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        if (currentXConst != null)
            TrigMath.sinMinMax(currentNz, currentXConst.doubleValue(), precision, min, max);
        else
            TrigMath.sinMinMax(currentNz, currentNx, precision, min, max);
