...
/**
 * Action that will attempt to assign a value to a long variable using the search tree.  In this context
 ...
 */
public class InstantiateLongAction extends AbstractSearchNodeAction {
     ...
     */
    public InstantiateLongAction(CspLongVariable var, LongSelector selector) {
        this.var = var;
     ...
     * @param var   Variable to instantiate
     */
    public InstantiateLongAction(CspLongVariable var) {
        this(var, null);
    }
    ...
    public SearchAction performAction() throws PropagationFailureException {
        ...
        // or remove it
        return choice(new AssignLongAction(var, nextVal),
                      combineActions(new RemoveLongAction(var, nextVal), this));
    }
}
