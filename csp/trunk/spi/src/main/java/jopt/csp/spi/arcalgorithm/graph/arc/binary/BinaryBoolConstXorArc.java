 ...
 */
public class BinaryBoolConstXorArc extends BinaryBoolArc {
     ...
     * Constraint
     * 
     * @param constVal  constBool to XOR with a
     ...
     */
    public BinaryBoolConstXorArc(boolean constVal, BooleanNode a, boolean notA, BooleanNode z, boolean notZ) {
        super(a, notA, z, notZ);
    ...
    public void propagate() throws PropagationFailureException {
        // a:T xor T -> F
        if ((aIsTrue())&&(constVal)) setTargetFalse();
        // a:T xor F -> T
