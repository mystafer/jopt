 ...
 * @author Nick
 */
public class GenericDiffSharedIdxTest extends TestCase {
    ...
    public GenericDiffSharedIdxTest(java.lang.String testName) {
        super(testName);
    }
    ...
    public void testEqual() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, zi, NumberMath.INTEGER, NumArc.EQ);
            arc.propagate();
            ...
            assertEquals("z1 min", new MutableNumber( (int) -65), znode1.getMin());
            assertEquals("z1 max", new MutableNumber( (int) 0), znode1.getMax());
            ...
            assertEquals("z2 min", new MutableNumber( (int) 1), znode2.getMin());
            assertEquals("z2 max", new MutableNumber( (int) 3), znode2.getMax());
            ...
            assertEquals("z3 min", new MutableNumber( (int) -5), znode3.getMin());
    ...
    public void testLessThan() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("y1 min", new MutableNumber( (int) 20), ynode1.getMin());
            assertEquals("y1 max", new MutableNumber( (int) 70), ynode1.getMax());
            assertEquals("z1 min", new MutableNumber( (int) -100), znode1.getMin());
            assertEquals("z1 max", new MutableNumber( (int) -1), znode1.getMax());
            assertFalse("z1 bound", znode1.isBound());
            ...
            assertEquals("y2 min", new MutableNumber( (int) 1), ynode2.getMin());
            assertEquals("y2 max", new MutableNumber( (int) 2), ynode2.getMax());
            assertEquals("z2 min", new MutableNumber( (int) -100), znode2.getMin());
            assertEquals("z2 max", new MutableNumber( (int) 2), znode2.getMax());
            assertFalse("z2 bound", znode2.isBound());
            ...
            assertEquals("y3 min", new MutableNumber( (int) 20), ynode3.getMin());
            assertEquals("y3 max", new MutableNumber( (int) 20), ynode3.getMax());
            assertEquals("z3 min", new MutableNumber( (int) -100), znode3.getMin());
            assertEquals("z3 max", new MutableNumber( (int) -6), znode3.getMax());
    ...
    public void testLessThanEqual() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, zi, NumberMath.INTEGER, NumArc.LEQ);
            arc.propagate();
    ...
    public void testGreaterThan() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, zi, NumberMath.INTEGER, NumArc.GT);
            arc.propagate();
            ...
            assertEquals("y2 min", new MutableNumber( (int) 1), ynode2.getMin());
            assertEquals("y2 max", new MutableNumber( (int) 2), ynode2.getMax());
            assertEquals("z2 min", new MutableNumber( (int) 2), znode2.getMin());
            ...
            assertEquals("y3 min", new MutableNumber( (int) 20), ynode3.getMin());
            assertEquals("y3 max", new MutableNumber( (int) 20), ynode3.getMax());
            assertEquals("z3 min", new MutableNumber( (int) -4), znode3.getMin());
    ...
    public void testGreaterThanEqual() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, zi, NumberMath.INTEGER, NumArc.GEQ);
            arc.propagate();
    ...
    public void testNotEqual() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, zi, NumberMath.INTEGER, NumArc.NEQ);
            arc.propagate();
            ...
            assertEquals("z1 max", new MutableNumber( (int) 100), znode1.getMax());
            assertFalse("z1 bound", znode1.isBound());
            assertEquals("z1 contains all elements", 201, znode1.getSize());
            ...
            assertEquals("z2 max", new MutableNumber( (int) 100), znode2.getMax());
            assertFalse("z2 bound", znode2.isBound());
            assertEquals("z2 contains all elements", 201, znode2.getSize());
            ...
            assertEquals("z3 max", new MutableNumber( (int) 100), znode3.getMax());
            assertFalse("z3 bound", znode3.isBound());
            assertEquals("z3 removed 1 element", 200, znode3.getSize());
            assertFalse("z3 contains 35", znode3.isInDomain(new MutableNumber( (int) -5)));
        }
        catch(PropagationFailureException propx) {
            fail();
        }
    ...
    public void testLessThanZSingle() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yi, znode1, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("z min", new MutableNumber( (int) -100), znode1.getMin());
            assertEquals("z max", new MutableNumber( (int) -6), znode1.getMax());
    ...
    public void testLessThanZXSingle() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xnode1, yi, znode1, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("z min", new MutableNumber( (int) -100), znode1.getMin());
            assertEquals("z max", new MutableNumber( (int) -1), znode1.getMax());
            assertFalse("z bound", znode1.isBound());
        }
        catch(PropagationFailureException propx) {
            fail();
    ...
    public void testLessThanZYSingle() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, ynode1, znode1, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("z min", new MutableNumber( (int) -100), znode1.getMin());
            assertEquals("z max", new MutableNumber( (int) -17), znode1.getMax());
            assertFalse("z bound", znode1.isBound());
        }
        catch(PropagationFailureException propx) {
            fail();
    ...
    public void testLessThanXConst() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(new MutableNumber( (int) 10), yi, zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("y2 max", new MutableNumber( (int) 2), ynode2.getMax());
            assertEquals("z2 min", new MutableNumber( (int) -100), znode2.getMin());
            assertEquals("z2 max", new MutableNumber( (int) 8), znode2.getMax());
            assertFalse("z2 bound", znode2.isBound());
    ...
    public void testLessThanYConst() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, new MutableNumber( (int) 10), zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            
            assertEquals("x1 min", new MutableNumber( (int) 5), xnode1.getMin());
            assertEquals("x1 max", new MutableNumber( (int) 20), xnode1.getMax());
            assertEquals("z1 min", new MutableNumber( (int) -100), znode1.getMin());
            assertEquals("z1 max", new MutableNumber( (int) 9), znode1.getMax());
            assertFalse("z1 bound", znode1.isBound());

            assertEquals("x2 min", new MutableNumber( (int) 3), xnode2.getMin());
            assertEquals("x2 max", new MutableNumber( (int) 4), xnode2.getMax());
            assertEquals("z2 min", new MutableNumber( (int) -100), znode2.getMin());
            assertEquals("z2 max", new MutableNumber( (int) -7), znode2.getMax());
            assertFalse("z2 bound", znode2.isBound());

            assertEquals("x3 min", new MutableNumber( (int) 15), xnode3.getMin());
            assertEquals("x3 max", new MutableNumber( (int) 15), xnode3.getMax());
            assertEquals("z3 min", new MutableNumber( (int) -100), znode3.getMin());
            assertEquals("z3 max", new MutableNumber( (int) 4), znode3.getMax());
            assertFalse("z3 bound", znode3.isBound());
        }
        catch(PropagationFailureException propx) {
            fail();
    ...
    protected void setUp() throws Exception {
        ...
        z1 = new IntVariable("z1", -100, 100);
        z2 = new IntVariable("z2", -100, 100);
        z3 = new IntVariable("z3", -100, 100);
