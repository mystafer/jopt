 ...
 * @author Nick
 */
public class GenericDiffSeperateIdxTest extends TestCase {
    ...
    public GenericDiffSeperateIdxTest(java.lang.String testName) {
        super(testName);
    }
    ...
    public void testEqualZiXiYj() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xi, yj, zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("z2 max", new MutableNumber ((int)-17), znode2.getMax());
    ...
    public void testEqualZiXjYi() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xj, yi, zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("y1 max", new MutableNumber ((int)70), ynode1.getMax());
            assertEquals("z1 min", new MutableNumber ((int)-100), znode1.getMin());
            assertEquals("z1 max", new MutableNumber ((int)-17), znode1.getMax());
            assertFalse("z1 bound", znode1.isBound());
            ...
            assertEquals("y3 max", new MutableNumber ((int)20), ynode3.getMax());
            assertEquals("z3 min", new MutableNumber ((int)-100), znode3.getMin());
            assertEquals("z3 max", new MutableNumber ((int)-17), znode3.getMax());
            assertFalse("z3 bound", znode3.isBound());
        }
        catch(PropagationFailureException propx) {
            fail();
    ...
    public void testEqualZiXjYj() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xj, yj, zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            ...
            assertEquals("y1 max", new MutableNumber ((int)70), ynode1.getMax());
            assertEquals("z1 min", new MutableNumber ((int)-100), znode1.getMin());
            assertEquals("z1 max", new MutableNumber ((int)-6), znode1.getMax());
            assertFalse("z1 bound", znode1.isBound());
    ...
    public void testEqualZiXjYcns() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(xj, new MutableNumber ((int)10), zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
            
            assertEquals("x1 min", new MutableNumber ((int)5), xnode1.getMin());
            assertEquals("x1 max", new MutableNumber ((int)20), xnode1.getMax());
            assertEquals("z1 min", new MutableNumber ((int)-100), znode1.getMin());
            assertEquals("z1 max", new MutableNumber ((int)-7), znode1.getMax());
            assertFalse("z1 bound", znode1.isBound());
            ...
            assertEquals("x3 max", new MutableNumber ((int)15), xnode3.getMax());
            assertEquals("z3 min", new MutableNumber ((int)-100), znode3.getMin());
            assertEquals("z3 max", new MutableNumber ((int)-7), znode3.getMax());
            assertFalse("z3 bound", znode3.isBound());
        }
        catch(PropagationFailureException propx) {
            fail();
    ...
    public void testEqualZiXcnsYj() {
        try {
            // propagate changes
            NumArc arc = new GenericNumDiffArc(new MutableNumber ((int)10), yj, zi, NumberMath.INTEGER, NumArc.LT);
            arc.propagate();
