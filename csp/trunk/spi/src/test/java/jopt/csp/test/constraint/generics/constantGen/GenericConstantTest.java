...
public class GenericConstantTest extends TestCase {
    ...
    public void testIndexManagerOneCommonIndexCombinationGeneration() {
        ...
        idxIter.next();
        assertEquals("The first element of intTest1 should be 6",new MutableNumber((int)6),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 0",new MutableNumber((int)0),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 7",new MutableNumber((int)7),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 5",new MutableNumber((int)5),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 3",new MutableNumber((int)3),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 4",new MutableNumber((int)4),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 2",new MutableNumber((int)2),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 2",new MutableNumber((int)2),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 0",new MutableNumber((int)0),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 6",new MutableNumber((int)6),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 0",new MutableNumber((int)0),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 1",new MutableNumber((int)1),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 5",new MutableNumber((int)5),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 3",new MutableNumber((int)3),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 6",new MutableNumber((int)6),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 2",new MutableNumber((int)2),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 2",new MutableNumber((int)2),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 3",new MutableNumber((int)3),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 6",new MutableNumber((int)6),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 0",new MutableNumber((int)0),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 9",new MutableNumber((int)9),intTest3.getNumberForIndex());
        idxIter.next();
        assertEquals("The first element of intTest1 should be 5",new MutableNumber((int)5),intTest1.getNumberForIndex());
        assertEquals("The first element of intTest2 should be 3",new MutableNumber((int)3),intTest2.getNumberForIndex());
        assertEquals("The first element of intTest3 should be 8",new MutableNumber((int)8),intTest3.getNumberForIndex());
    }
}