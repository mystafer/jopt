 ...
 */
public class GenericBoolImpliesThreeVarArc extends GenericBoolArc {
    /**
     * Constraint
     * 
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolImpliesThreeVarArc(Node x, boolean notX, boolean y, Node z, boolean notZ) {
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolImpliesThreeVarArc(Node x, boolean notX, GenericBooleanConstant y, Node z, boolean notZ) {
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolImpliesThreeVarArc(boolean x, Node y, boolean notY, Node z, boolean notZ) {
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolImpliesThreeVarArc(GenericBooleanConstant x, Node y, boolean notY, Node z, boolean notZ) {
