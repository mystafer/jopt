 ...
 */
public class GenericNumAtanArc extends GenericNumTrigArc {
     ...
     */
    public GenericNumAtanArc(Node x, Node z, int nodeType, int arcType) {
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumAtanArc(Number x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumAtanArc(GenericNumConstant x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        if (currentXConst != null)
            TrigMath.atanMinMax(currentNz, currentXConst.doubleValue(), precision, min, max);
        else
            TrigMath.atanMinMax(currentNz, currentNx, precision, min, max);
