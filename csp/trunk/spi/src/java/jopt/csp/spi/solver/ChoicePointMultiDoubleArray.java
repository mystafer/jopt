 ...
 */
public class ChoicePointMultiDoubleArray implements ChoicePointNumArraySet.StackList {
	private ArrayIntList basePointerStack;
    private ArrayIntList sizeStack;
    private double dataStacks[][];
    ...
    /**
     * Creates a new <code>ChoicePointMultiDoubleArray</code>
     * 
    ...
    public ChoicePointMultiDoubleArray(int listCnt) {
        ...
        this.dataStacks = new double[listCnt][capacity];
     ...
     * @param offset    Offset of value in list
     */
    public double get(int listIdx, int offset) {
        if (offset < 0)
            throw new IndexOutOfBoundsException("invalid value offset");
     ...
     * @param offset    Offset of value in list
     */
    public double remove(int listIdx, int offset) {
        if (offset < 0)
            throw new IndexOutOfBoundsException("invalid value offset");
        ...
        // convert to an actual offset in arrays
        int actualOffset = basePointer + offset;
        double dataStack[] = dataStacks[listIdx];
        double val = dataStack[actualOffset]; 
