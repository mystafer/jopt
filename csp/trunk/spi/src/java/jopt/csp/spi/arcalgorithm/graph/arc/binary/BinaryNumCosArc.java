 ...
 */
public class BinaryNumCosArc extends BinaryNumArc {
     ...
     */
    public BinaryNumCosArc(NumNode x, NumNode z, int nodeType, int arcType) {
        super(x, null, null, null, z, nodeType, arcType, NumOperation.COS);
    }
    ...
    protected void propagateBounds() throws PropagationFailureException {
        ...
        TrigMath.cosMinMax(z, x, z.getPrecision(), min, max);
