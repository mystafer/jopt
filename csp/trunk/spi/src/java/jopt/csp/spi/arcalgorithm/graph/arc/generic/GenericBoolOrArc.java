 ...
 */
public class GenericBoolOrArc extends GenericBoolArc implements NumArc {
    /**
     * Constraint
     * 
     ...
     */
    public GenericBoolOrArc(Node x, boolean notX, Node y, boolean notY, Node z, boolean notZ) {
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolOrArc(Node x, boolean notX, boolean y, Node z, boolean notZ) {
        super(x, notX, new Boolean(y), z, notZ);
    }
    
    public GenericBoolOrArc(Node x, boolean notX, GenericBooleanConstant y, Node z, boolean notZ) {
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        else if (isAnyYFalse() && isAnyXFalse()) {
            setTargetFalse();
        }
    }
}
