 ...
 */
public class TernaryNumBetweenArc extends TernaryNumRangeArc {
     ...
     */
    public TernaryNumBetweenArc(Number sourceMin, boolean minExclusive, Number sourceMax, boolean maxExclusive, 
     ...
     * @param   nodeType        Node variable type (Integer, Long, Float, Decimal)
     */
    public TernaryNumBetweenArc(Number sourceMin, boolean minExclusive, NumNode sourceMax, boolean maxExclusive,
    		NumNode target, int nodeType) 
    {
        super(sourceMin, minExclusive, sourceMax, maxExclusive, target, nodeType);
    }
     ...
     * @param   nodeType        Node variable type (Integer, Long, Float, Decimal)
     */
    public TernaryNumBetweenArc(NumNode sourceMin, boolean minExclusive, Number sourceMax, boolean maxExclusive,
            NumNode target, int nodeType) 
    {
        super(sourceMin, minExclusive, sourceMax, maxExclusive, target, nodeType);
    }
     ...
     * @param   nodeType        Node variable type (Integer, Long, Float, Decimal)
     */
    public TernaryNumBetweenArc(NumNode sourceMin, boolean minExclusive, NumNode sourceMax, boolean maxExclusive,
            NumNode target, int nodeType) 
    {
        super(sourceMin, minExclusive, sourceMax, maxExclusive, target, nodeType);
    }
