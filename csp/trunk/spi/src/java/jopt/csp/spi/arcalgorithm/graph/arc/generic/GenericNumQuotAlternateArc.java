 ...
 */
public class GenericNumQuotAlternateArc extends GenericNumArc implements NumArc {
     ...
     */
    public GenericNumQuotAlternateArc(Node x, Node y, Node z, int nodeType, int arcType) {
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumQuotAlternateArc(Number x, Node y, Node z, int nodeType, int arcType) {
        super(x, y, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumQuotAlternateArc(GenericNumConstant x, Node y, Node z, int nodeType, int arcType) {
        super(x, y, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumQuotAlternateArc(Node x, Number y, Node z, int nodeType, int arcType) {
        super(x, y, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumQuotAlternateArc(Node x, GenericNumConstant y, Node z, int nodeType, int arcType) {
        super(x, y, z, nodeType, arcType);    
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumQuotAlternateArc(Number x, Number y, Node z, int nodeType, int arcType) {
        super(x, y, z, nodeType, arcType);
    }
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        boolean zContainsZero = isInDomainZ(zero) || (NumberMath.isPositive(getLargestMaxZ()) && NumberMath.isNegative(getSmallestMinZ()));
        ...
        switch(arcType) {
            case GEQ:
                ...
                else if ( (NumberMath.isPositive(getSmallestMinZ()) && NumberMath.isPositive(getSmallestMinY())) || 
                          (NumberMath.isNegative(getLargestMaxZ()) && NumberMath.isNegative(getLargestMaxZ())) )
