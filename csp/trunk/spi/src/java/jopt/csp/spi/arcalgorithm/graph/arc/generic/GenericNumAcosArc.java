 ...
 */
public class GenericNumAcosArc extends GenericNumTrigArc {
     ...
     */
    public GenericNumAcosArc(Node x, Node z, int nodeType, int arcType) {
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumAcosArc(Number x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumAcosArc(GenericNumConstant x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        if (currentXConst != null)
            TrigMath.acosMinMax(currentNz, currentXConst.doubleValue(), precision, min, max);
        else
        	TrigMath.acosMinMax(currentNz, currentNx, precision, min, max);
