...
//            }
        ...
        //Here we must check whether or not the constraint is violated, without getting
        //luck with the fact that the range of z is completely greater or lesser than the min / max
        // Number upperBoundLowerHalf = currentZ.getNextLower(rmgr, runtimeMax);
         Number lowerBoundUpperHalf = currentZ.getNextHigher(runtimeMin);
        // cmp = NumberMath.compare(runtimeMin,
        // upperBoundLowerHalf, precision, nodeType);
