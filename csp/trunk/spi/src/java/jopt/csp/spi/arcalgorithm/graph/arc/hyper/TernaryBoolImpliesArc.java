 ...
 */
public class TernaryBoolImpliesArc extends TernaryBoolArc {
    /**
     * Constraint
     * 
     ...
     */
    public TernaryBoolImpliesArc(BooleanNode x, boolean notX, BooleanNode y, boolean notY, BooleanNode z, boolean notZ) {
