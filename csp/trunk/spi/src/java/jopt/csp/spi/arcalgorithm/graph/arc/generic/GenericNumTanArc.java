 ...
 */
public class GenericNumTanArc extends GenericNumTrigArc {
     ...
     */
    public GenericNumTanArc(Node x, Node z, int nodeType, int arcType) {
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumTanArc(Number x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
     ...
     * @param   arcType     Arc relation type (Eq, Lt, Gt, etc.)
     */
    public GenericNumTanArc(GenericNumConstant x, Node z, int nodeType, int arcType) {
        super(x, z, nodeType, arcType);
    }
    ...
    protected void propagateCurrentNodes() throws PropagationFailureException {
        ...
        if (currentXConst != null)
            TrigMath.tanMinMax(currentNz, currentXConst.doubleValue(), precision, min, max);
        else
            TrigMath.tanMinMax(currentNz, currentNx, precision, min, max);
