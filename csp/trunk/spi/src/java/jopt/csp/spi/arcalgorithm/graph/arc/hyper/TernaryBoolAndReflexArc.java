 ...
 */
public class TernaryBoolAndReflexArc extends TernaryBoolArc {
    /**
     * Constraint
     * 
     ...
     */
    public TernaryBoolAndReflexArc(BooleanNode x, boolean notX, BooleanNode y, boolean notY, BooleanNode z, boolean notZ) {
    ...
    public void propagate() throws PropagationFailureException {
    	...
    	if(xIsTrue()) setTargetTrue();
    	if((xIsFalse())&&(yIsTrue())) setTargetFalse();
