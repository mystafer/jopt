...
public abstract class SetVariableBase extends VariableChangeBase implements CspSetVariable, SetVariable, Variable {
     ...
     * Constructor
     */
    protected SetVariableBase(String name, SetDomain domain) {
        this.name = name;
        this.domain = domain;
    }
    ...
    public final boolean equals(Object obj) {
    	if(obj instanceof SetVariableBase) {
    		return ((SetVariableBase) obj).getName().equals(this.name);
    	}
    	else {
    		return false;
    	}
