 ...
 */
public class GenericBoolXorArc extends GenericBoolArc implements NumArc {
    /**
     * Constraint
     * 
     ...
     */
    public GenericBoolXorArc(Node x, boolean notX, Node y, boolean notY, Node z, boolean notZ) {
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolXorArc(Node x, boolean notX, boolean y, Node z, boolean notZ) {
     ...
     * @param notZ      True if left side of equation is equal to !Z, false if left side is equal to Z
     */
    public GenericBoolXorArc(Node x, boolean notX, GenericBooleanConstant y, Node z, boolean notZ) {
