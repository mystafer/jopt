...
/**
 * An integer array that stores data for an object that needs to record changes in a
 ...
 */
public class ChoicePointIntArray implements ChoicePointNumArraySet.StackList {
    ...
    /**
     * Creates a new <code>ChoicePointIntArray</code>
     */
    public ChoicePointIntArray() {
        this.capacity = 10;
