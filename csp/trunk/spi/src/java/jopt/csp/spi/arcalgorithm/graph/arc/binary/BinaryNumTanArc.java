 ...
 */
public class BinaryNumTanArc extends BinaryNumArc {
     ...
     */
    public BinaryNumTanArc(NumNode x, NumNode z, int nodeType, int arcType) {
        super(x, null, null, null, z, nodeType, arcType, NumOperation.TAN);
    }
    ...
    protected void propagateBounds() throws PropagationFailureException {
        ...
        TrigMath.tanMinMax(z, x, z.getPrecision(), min, max);
