...
public class FourQueen {
	private static ConstraintStore store = new ConstraintStore(new AC5(), false);
	private static ChoicePointAlgorithm gac = store.getConstraintAlg();
	private static ChoicePointStack choicestack = store.getChoicePointStack();
